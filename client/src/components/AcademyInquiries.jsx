...
export default function AcademyInquiries() {
    ...
    <section className="relative py-24 flex items-center justify-center text-center overflow-hidden bg-black">
      ...
      >
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          Got inquiries, reach out{" "}
          <span className="text-[var(--color-primary-500)]">via</span>
        </motion.h2>

        <motion.p
          className="text-gray-200 text-2xl leading-relaxed mb-8"
