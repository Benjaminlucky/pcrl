    ...
    <>
      <section className="relative py-24 flex items-center justify-center text-center overflow-hidden bg-black">
        <motion.div
          ...
          style={{ backgroundImage: "url('/images/burbleBg.jpg')" }}
          initial={{ scale: 1.1 }}
          whileInView={{
            scale: 1,
        ...
        <motion.div
          ...
          animate={{
            background: `radial-gradient(400px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(255, 0, 0, ${pulseIntensity}), transparent 80%)`,
          }}
          transition={{
            ease: "easeInOut",
            duration: 1.5,
        ...
        >
          ...
          >
            ...
            Together, we'll create visibility, credibility, and unstoppable
            sales momentum.
          </motion.p>
