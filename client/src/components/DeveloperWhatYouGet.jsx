...
const WhatYouGet = () => {
  ...
  const cameraZoomVariants = {
    ...
    visible: { scale: 1, y: 0, transition: { duration: 1.5, ease: "easeOut" } },
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* Background Stripes */}
        <div className="absolute inset-0 bg-[repeating-linear-gradient(90deg,_rgba(255,255,255,0.05)_0,_rgba(255,255,255,0.05)_1px,_transparent_1px,_transparent_120px)] pointer-events-none" />
        ...
        >
          ...
          <div className="w-full lg:w-1/2 pb-12 lg:pb-24">
            ...
            {/* Glowing Button — now opens EngageModal */}
            <motion.button
      ...
      <EngageModal isOpen={engageOpen} onClose={() => setEngageOpen(false)} />
    </>
  );
};
